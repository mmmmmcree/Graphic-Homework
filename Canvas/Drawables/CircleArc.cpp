...
CircleArc::CircleArc(int pixel_size)
{
...
void CircleArc::draw()
{
    switch(m_draw_step) {
        ...
        case 2: {
            ...
            Drawable::drawLine({m_x, m_y, m_color}, {m_x + dx, m_y + dy, m_color}, m_pixel_size);
        ...
        case 1: {
            ...
            Drawable::drawLine({m_x, m_y, m_color}, {m_x + dx1, m_y + dy1, m_color}, m_pixel_size);
            Drawable::drawLine({m_x, m_y, m_color}, {m_x + dx2, m_y + dy2, m_color}, m_pixel_size);
        } break;
    }
